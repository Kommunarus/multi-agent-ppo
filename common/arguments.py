...
def get_common_args():
    ...
    parser.add_argument('--model_dir', type=str, default='./model_ppo', help='the model directory of the policy')
    parser.add_argument('--result_dir', type=str, default='./model_ppo', help='the result directory of the policy')
    parser.add_argument('--learn', type=bool, default=True, help='whether to train the model')
    parser.add_argument('--threshold', type=int, default=19, help='the threshold to judge whether win')
    parser.add_argument('--evaluate_cycle', type=int, default=10_000, help='how often to evaluate the model')
